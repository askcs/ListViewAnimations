...
/**
 * An {@link OnTouchListener} for the {@link ContextualDialogAdapter}. Don't use
 * this class directly, use ContextualDialogAdapter to wrap your
 * {@link BaseAdapter}s.
 */
public class ContextualDialogListViewTouchListener implements SwipeOnTouchListener {
	...
	public ContextualDialogListViewTouchListener(AbsListView listView, Callback callback) {
	...
	public boolean onTouch(View view, MotionEvent motionEvent) {
		...
		case MotionEvent.ACTION_DOWN: {
			...
			if (mDownView != null && mDownView instanceof ContextualDialogView) {
