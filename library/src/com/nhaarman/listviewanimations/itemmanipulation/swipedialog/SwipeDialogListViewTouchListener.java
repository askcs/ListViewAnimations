...
/**
 * An {@link OnTouchListener} for the {@link SwipeDialogAdapter}. Don't use
 * this class directly, use ContextualDialogAdapter to wrap your
 * {@link BaseAdapter}s.
 */
public class SwipeDialogListViewTouchListener implements SwipeOnTouchListener {
	...
	public SwipeDialogListViewTouchListener(AbsListView listView, Callback callback) {
	...
	public boolean onTouch(View view, MotionEvent motionEvent) {
		...
		case MotionEvent.ACTION_DOWN: {
			...
			if (mDownView != null && mDownView instanceof SwipeDialogView) {
